...
const sections: [string, string][] = [
  ...
  ["4. Advertiser Obligations", "Advertisers pay for orders upfront via secure card checkout. Payments are processed directly to ReviewMarket. Advertisers must not request false claims, defamatory content, or violations of any platform's terms of service."],
  ...
  ["7. Prohibited Conduct", "You may not use ReviewMarket to engage in unlawful activity, harass other users, scrape the platform, or circumvent the payment system."],
